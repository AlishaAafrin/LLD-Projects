...
public class CabBookingAppMain {
  public static void main(String[] args) {
    ...
    Cab cab1 = new Cab(driver1, cabLocation1,"AB1234");

    Cab cab2 = new Cab(driver2, cabLocation2,"DE1234");

    Cab cab3 = new Cab(driver3,cabLocation3, "FG1234");
    ...
    System.out.println(rider.getRiderStatus());

    System.out.println(RiderManager.getInstance().findRider("Mukesh").getRiderStatus());
  }
}